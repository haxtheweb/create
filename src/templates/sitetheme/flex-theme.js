...
/**
 * `<%= className %>`
 * `<%= className %> theme based on modern flex design system`
 *
 ...
 * @element <%= customName %>
 */
class <%= className %> extends LTIResizingMixin(
  ...
  static get styles() {
    return [
      ...
      css`
        ...
        :host([responsive-size="xl"]) #slot {
          width: calc(var(--menu-size) + 70%);
          margin: 0 auto;
        }
        :host([responsive-size="lg"]) #slot {
          width: calc(var(--menu-size) + 70%);
          margin: 0 auto;
        }
        :host([responsive-size="md"]) #slot {
          width: calc(var(--menu-size) + 65%);
          margin: 0 auto;
        }
        :host([responsive-size="sm"]) #slot {
          width: calc(var(--menu-size) + 40%);
          margin: 0 auto;
        }
        :host([responsive-size="xs"]) #slot {
